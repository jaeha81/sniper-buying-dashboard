...
export default function TermsPage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-3xl">
      ...
      <Card>
        <CardContent className="p-6 text-gray-700 space-y-8 text-sm leading-relaxed">
          <section>
          ...
          <section>
            <h2 className="text-base font-semibold text-gray-900 mb-2">제2조 (서비스 내용)</h2>
            ...
            <p className="mt-2">서비스 내용은 회사 사정에 따라 변경될 수 있으며, 변경 시 7일 전에 공지합니다.</p>
          </section>

          <section>
            <h2 className="text-base font-semibold text-gray-900 mb-2">제3조 (구매대행 서비스)</h2>
            <p className="mb-2">
          ...
          <section>
            <h2 className="text-base font-semibold text-gray-900 mb-2">제4조 (요금 및 결제)</h2>
            <ul className="list-disc list-inside space-y-1">
          ...
          <section>
            <h2 className="text-base font-semibold text-gray-900 mb-2">제5조 (취소 및 환불)</h2>
            <ul className="list-disc list-inside space-y-1">
            ...
            <p className="mt-2">환불 처리는 취소 확정 후 3~10영업일 이내에 완료됩니다.</p>
          </section>

          <section>
            <h2 className="text-base font-semibold text-gray-900 mb-2">제6조 (면책사항)</h2>
            <p className="mb-2">회사는 다음 사유로 인한 손해에 대해 책임을 지지 않습니다.</p>
            <ul className="list-disc list-inside space-y-1">
          ...
          <section>
            <h2 className="text-base font-semibold text-gray-900 mb-2">제7조 (분쟁 해결)</h2>
            <p>
